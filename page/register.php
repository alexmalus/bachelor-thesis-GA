...
class page_register extends Page {
    ...
    function init() {
		...
		//daca nu este scrum master, nu are voie sa inregistreze pe altcineva
        ...
        $form->setModel($model, array('first_name', 'last_name', 'mail'));
        $form->addField('password', 'password_1', 'Password');
        $form->addField('password', 'password_2', 'Password')->setFieldHint('Reintrodu parola');
